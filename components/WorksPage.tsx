...
const SERVICES = [
   {
      ...
      videos: [
         ...
         },
         {
            ...
            src: 'https://www.dropbox.com/scl/fo/gq9u9ugq1bg0xxkruhd2h/ALHz6ku9MUx4WP6Drr7Hbdw/Horizontal%20Content/ANDREW%20VSL.mp4?rlkey=ecoqcz4h9sos2wo3filjcmake&st=w1o3tl98&raw=1'
         },
         {
            id: 'koffee',
            title: 'KOFFEE CO.',
            description: 'Premium commercial production.',
                                 ...
                                 <div className="flex flex-col w-full py-12 gap-24 md:gap-32">
                                    {currentService.videos.slice(0, visibleVideos).map((video: any) => (
                                       <div key={video.id} className={`group relative w-full bg-black/5 overflow-hidden mx-auto ${currentService.id === 'shorts' ? 'aspect-[9/16] max-w-md' : 'aspect-[16/9]'}`}>
                                          <video src={video.src} className="w-full h-full object-cover" muted loop playsInline preload="metadata" onMouseEnter={(e) => e.currentTarget.play()} onMouseLeave={(e) => e.currentTarget.pause()} />
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-8">
                                       {currentService.videos.map((video: any) => (
                                          <div key={video.id} className="relative aspect-[9/16] group overflow-hidden bg-black/5">
                                             <video src={video.src} className="w-full h-full object-cover" muted loop playsInline preload="metadata" onMouseEnter={(e) => e.currentTarget.play()} onMouseLeave={(e) => { e.currentTarget.pause(); e.currentTarget.currentTime = 0; }} />
